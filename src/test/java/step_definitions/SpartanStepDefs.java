...
public class SpartanStepDefs {
    ...
    public void the_User_retrives_the_phone_number_for_the_spartan(String name) {
        ...
        expectedPhoneNumber = (String) rowMap.get("PHONE");

    }

    @Then("the phone number from DB should be {string}")
    public void the_phone_number_from_DB_should_be(String actualPhone) {
